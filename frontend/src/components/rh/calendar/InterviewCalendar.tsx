...
import {
    ...
    CalendarDays, StickyNote, TrendingUp,
     Briefcase, X,
...
import { WeekStatsGrid, NotificationsList, OfferTimelineCard } from './components'
import {getDjangoDayNum} from "../../../types/utils.ts";
import {
    AIInterviewCalendar, DayEvent,
    DeleteTarget,
    NOTE_CFG,
    NoteLevel,
    OfferTimeline, RHNote, RHNotification,
    WeekStats
} from "../../../types/types.ts";
...
function InterviewCalendar() {
    ...
    const [notifications, setNotifications] = useState<RHNotification[]>([])
    ...
    return (
        <div className="space-y-6">
            {weekStats && <WeekStatsGrid weekStats={weekStats} />}
